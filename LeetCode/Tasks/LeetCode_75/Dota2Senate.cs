...
public class Dota2Senate
{
     ...
     * In the world of Dota2, there are two parties: the Radiant and the Dire.
       ...
       Now the Senate wants to decide on a change in the Dota2 game. The voting for this change is a round-based procedure. In each round, each senator can exercise one of the two rights:
       ...
       represent the Radiant party and the Dire party. Then if there are n senators, the size of the given string will be n.
    ...
    public string PredictPartyVictory(string senate) {
        var queueR = new Queue<int>();
        var queueD = new Queue<int>();
        var n = senate.Length;
        ...
        return queueD.Count == 0 ? "Radiant" : "Dire";
    }
}